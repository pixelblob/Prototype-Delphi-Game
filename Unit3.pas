...
var
  ...
  //delete when TResourceStream is figured out
  //pauseScreen : TImage;
  //--------------------
  bush, tree1, tree2, tree3, tree4, playerImage,
  selectorImage,nopeSelectorImage, heartImage, pauseScreen: TGraphic;  // <- add to list when figure out that TResourceStream thing
...
begin
  ...
  T.Free;
  //pauseScreen.Picture.LoadFromFile('.\images\pause_screen.jpg');
